...
//diplay timestapm [YYYYMMDD_HHMMSS]
//usage of std functions time and localtime
void Account::_displayTimestamp(){
	std::time_t time_in_secs = std::time(NULL); //gets global time in seconds since 1970
	std::tm *time = std::localtime(&time_in_secs); //converts g_time into a std:tm struct with a calendar with understandable info and returns a struct
